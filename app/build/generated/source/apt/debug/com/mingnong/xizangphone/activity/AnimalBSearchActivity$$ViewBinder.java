...
public class AnimalBSearchActivity$$ViewBinder<T extends AnimalBSearchActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends AnimalBSearchActivity> implements Unbinder {
    private T target;
