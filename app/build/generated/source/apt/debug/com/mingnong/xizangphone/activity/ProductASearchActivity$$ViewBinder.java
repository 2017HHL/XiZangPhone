...
public class ProductASearchActivity$$ViewBinder<T extends ProductASearchActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ProductASearchActivity> implements Unbinder {
    private T target;
