...
public class ProductBSearchActivity$$ViewBinder<T extends ProductBSearchActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends ProductBSearchActivity> implements Unbinder {
    private T target;
