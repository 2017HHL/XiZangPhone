...
public class QueryDetilProductBActivity$$ViewBinder<T extends QueryDetilProductBActivity> implements ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755404, "field 'tvProductDanwei'");
    target.tvProductDanwei = finder.castView(view, 2131755404, "field 'tvProductDanwei'");
  ...
  protected static class InnerUnbinder<T extends QueryDetilProductBActivity> implements Unbinder {
    private T target;
