...
public class QueryListAnimalAActivity$$ViewBinder<T extends QueryListAnimalAActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends QueryListAnimalAActivity> implements Unbinder {
    private T target;
