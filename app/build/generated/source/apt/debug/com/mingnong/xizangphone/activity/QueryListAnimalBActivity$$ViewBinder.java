...
public class QueryListAnimalBActivity$$ViewBinder<T extends QueryListAnimalBActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends QueryListAnimalBActivity> implements Unbinder {
    private T target;
