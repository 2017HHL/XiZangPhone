...
public class QueryListProductBActivity$$ViewBinder<T extends QueryListProductBActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends QueryListProductBActivity> implements Unbinder {
    private T target;
