...
public class QueryListWHHActivity$$ViewBinder<T extends QueryListWHHActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends QueryListWHHActivity> implements Unbinder {
    private T target;
