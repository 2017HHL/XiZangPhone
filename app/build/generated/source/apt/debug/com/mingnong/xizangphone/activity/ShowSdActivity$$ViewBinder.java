...
public class ShowSdActivity$$ViewBinder<T extends ShowSdActivity> implements ViewBinder<T> {
  @Override
  public Unbinder bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755282, "field 'rlEmpty'");
    target.rlEmpty = finder.castView(view, 2131755282, "field 'rlEmpty'");
    return unbinder;
  }
  ...
  protected static class InnerUnbinder<T extends ShowSdActivity> implements Unbinder {
    private T target;
