...
public class TuZaiJianYiChaXunActivity$$ViewBinder<T extends TuZaiJianYiChaXunActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends TuZaiJianYiChaXunActivity> implements Unbinder {
    private T target;
