...
public class WuHaiHuaAddActivity$$ViewBinder<T extends WuHaiHuaAddActivity> implements ViewBinder<T> {
  @Override
  ...
  protected static class InnerUnbinder<T extends WuHaiHuaAddActivity> implements Unbinder {
    private T target;
