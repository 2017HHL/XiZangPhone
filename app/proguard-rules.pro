...
#保证实体类不能被混淆
-keep class com.mingnong.xizangphone.bean.** { *;}
-keep class com.mingnong.xizangphone.dao.** {*;}

-dontwarn com.zhy.m.permission.**
-keep class com.zhy.m.permission.**{*;}
-keep class **$$PermissionProxy { *; }
-keep class android.Manifest{*;}
-dontwarn com.mingnong.xizangphone.activity.**
-keepnames class com.mingnong.xizangphone.activity.LoginActivity$*{
    public <fields>;
    public <methods>;
}
# -------------系统类不需要混淆 --------------------------
