...
import com.mingnong.xizangphone.presenter.AnimalASearchActivityPresenter;
 ...
 */
public class AnimalASearchActivity extends MVPActivity<AnimalASearchActivityPresenter> implements IAnimalASearchActivity, SpringView.OnFreshListener, IMVPList {
    ...
    private AnimalASearchAdapter adapter;
    ...
    @Override
    protected AnimalASearchActivityPresenter createPresenter() {
        return new AnimalASearchActivityPresenter(this);
    }
    ...
    public void bindData() {
        ...
        adapter = new AnimalASearchAdapter(this, new ArrayList<>(), headSearchView.getHeaderView());
    ...
    public void bindListener() {
        ...
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener(new RecyclerItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                if (position != 0) {
                    Intent intent = new Intent(AnimalASearchActivity.this, AnimalAActivity.class);
    ...
    @Override
    public void setData(List<QueryAnimABean.DataListBean> dataListEntity) {
