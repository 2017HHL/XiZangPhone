...
import com.mingnong.xizangphone.interfac.IChanDiJianYIXiangQActivity;
import com.mingnong.xizangphone.presenter.ChanDiJianYIXiangQActivityP;
...
public class ChanDiJianYIXiangQActivity extends MVPActivity<ChanDiJianYIXiangQActivityP> implements IChanDiJianYIXiangQActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chan_di_jian_yixiang_q);
        ButterKnife.bind(this);
    }

    @Override
    protected ChanDiJianYIXiangQActivityP createPresenter() {
        return new ChanDiJianYIXiangQActivityP(this);
    }

    @Override
    public void bindData() {
        tvTitle.setText("场地检疫申报单详情");
        ...
        tvShijian3.setText(dataListBean.getPTRADEMARK());//运载工具牌号
