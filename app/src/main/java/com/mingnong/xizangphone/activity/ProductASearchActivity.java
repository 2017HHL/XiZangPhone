...
import com.mingnong.xizangphone.adapter.ProductASearchAdapter;
...
import com.mingnong.xizangphone.presenter.ProductASearchActivityPresenter;
 ...
 */
public class ProductASearchActivity extends MVPActivity<ProductASearchActivityPresenter> implements IProductASearchActivity, SpringView.OnFreshListener, IMVPList {
    ...
    private ProductASearchAdapter adapter;
    ...
    @Override
    protected ProductASearchActivityPresenter createPresenter() {
        return new ProductASearchActivityPresenter(this);
    }
    ...
    public void bindData() {
        ...
        adapter = new ProductASearchAdapter(this, new ArrayList<>(), headSearchView.getHeaderView());
    ...
    public void bindListener() {
        ...
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener(new RecyclerItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                if (position != 0) {
                    Intent intent = new Intent(ProductASearchActivity.this, ProductAActivity.class);
