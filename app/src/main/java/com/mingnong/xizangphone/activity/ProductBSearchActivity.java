...
import com.mingnong.xizangphone.adapter.ProductBSearchAdapter;
...
import com.mingnong.xizangphone.presenter.ProductBSearchActivityPresenter;
 ...
 */
public class ProductBSearchActivity extends MVPActivity<ProductBSearchActivityPresenter> implements IProductBSearchActivity, SpringView.OnFreshListener, IMVPList {
    ...
    private ProductBSearchAdapter adapter;
    ...
    @Override
    protected ProductBSearchActivityPresenter createPresenter() {
        return new ProductBSearchActivityPresenter(this);
    }
    ...
    public void bindData() {
        ...
        adapter = new ProductBSearchAdapter(this, new ArrayList<>(), headSearchView.getHeaderView());
    ...
    public void bindListener() {
        ...
        RecyclerItemClickSupport.addTo(mRecyclerView).setOnItemClickListener(new RecyclerItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                if (position != 0) {
                    Intent intent = new Intent(ProductBSearchActivity.this, ProductBActivity.class);
