 ...
 */
public class ChandiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChandiAdapter(Context context, List<QueryProductABean.DataListBean> list, View headerView) {
