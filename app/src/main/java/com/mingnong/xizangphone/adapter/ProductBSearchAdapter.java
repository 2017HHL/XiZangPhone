 ...
 */
public class ProductBSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProductBSearchAdapter(Context context, List<QueryProductBBean.DataListBean> list, View headerView) {
...
//            ((ListviewViewHolder) holder).tvHarmlseeType.setText(list.get(position - 1).getIsPrant());
    ...
    public int getItemViewType(int position) {
        if (position == 0) {
            return ProductBSearchAdapter.ITEM_TYPE.ITEM_HEAD.ordinal();
        } else {
            return ProductBSearchAdapter.ITEM_TYPE.ITEM_LISTVIEM.ordinal();
        }
    }
