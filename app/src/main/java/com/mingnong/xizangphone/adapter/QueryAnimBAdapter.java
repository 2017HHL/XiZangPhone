...
public class QueryAnimBAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private List<QueryAnimBBean.DataListBean> list;
    ...
    public QueryAnimBAdapter(Context context, List<QueryAnimBBean.DataListBean> list, View headerView) {
