 ...
 */
public class QueryListCDAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<QueryListChangDI.DataListBean> list = new ArrayList<>();
    ...
    public QueryListCDAdapter(Context context, List<QueryListChangDI.DataListBean> list, View headerView) {
    ...
    public List<QueryListChangDI.DataListBean> getDates() {
        return list;
    }

    public void setmDatas(List<QueryListChangDI.DataListBean> list) {
        if (this.list == null) {
            this.list = list;
        } else {
            this.list.clear();
    ...
    public void addAll(List<QueryListChangDI.DataListBean> list) {
        if (this.list == null) {
            this.list = list;
        } else {
            this.list.addAll(list);
