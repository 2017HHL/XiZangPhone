...
//        return new DaoMaster(new MySQLiteOpenHelper(context, dbName, null).getWritableDatabase());
    ...
    public void insertOrUpdateUnit() {
        new Thread(() -> {
            ...
            try {
                ...
                List<Unit> units = new Gson().fromJson(new InputStreamReader(inputStream), new TypeToken<List<Unit>>(){}.getType());
    ...
    public void insertOrUpdateCodeXD() {
        new Thread(() -> {
            ...
            try {
                ...
                List<CodeXD> codeXDs = new Gson().fromJson(new InputStreamReader(inputStream), new TypeToken<List<CodeXD>>(){}.getType());
    ...
    private SQLiteDatabase getWritableDatabase() {
        if (openHelper == null) {
            openHelper = new DaoMaster.DevOpenHelper(MyApplication.getContext(),"SHEN_SHI_XIAN_BEAN");
        }
     ...
     * @param ShenShiXian
     */
    public void saveShen(List<ShenShiXianBean> ShenShiXian) {
        daoSession.getShenShiXianBeanDao().insertInTx(ShenShiXian);
    }
     ...
     * @param xiaoXiDaoBeen
     */
    public void saveXiaoxi(List<XiaoXiDaoBean> xiaoXiDaoBeen) {
        daoSession.getXiaoXiDaoBeanDao().insertInTx(xiaoXiDaoBeen);
    }
    /**
     * 查询所得的Xiaoxi
     */
    public List<XiaoXiDaoBean> queryXiaoxi() {
        return daoSession.getXiaoXiDaoBeanDao().loadAll();
    }
    /**
     * 查询所得的省市县
     */
    public List<ShenShiXianBean> queryShenShiXian() {
        return daoSession.getShenShiXianBeanDao().loadAll();
    }
    /**
     * 查询所有的省
     */
