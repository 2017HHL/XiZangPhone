...
import com.mingnong.xizangphone.adapter.ErBiaoAdapter;
import com.mingnong.xizangphone.bean.local.ErBiaoEntity;
...
public class ErBiaoDialog extends Dialog implements View.OnClickListener {
    ...
    private int currentType, currentCount, maxCount;
    ...
    private void findViews(View parent) {
        spinner = (Spinner) parent.findViewById(R.id.ErSpinner);
        spinner.setAdapter(new ArrayAdapter<String>(getContext(), R.layout.spinner_erbiao, R.id.t1,
                spinnerAdapterString));
        // 初始化
