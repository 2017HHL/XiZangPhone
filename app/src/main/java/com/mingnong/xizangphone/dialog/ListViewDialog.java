...
import com.mingnong.xizangphone.adapter.SetefilizeAdapter;
...
public class ListViewDialog extends Dialog {
    ...
    public static class Buidle{
        ...
        public ListViewDialog create(){
            final ListViewDialog dialog;
            dialog = new ListViewDialog(context,params.shadow? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            View view = LayoutInflater.from(context).inflate(R.layout.dialog_picker_firstgai,null);
