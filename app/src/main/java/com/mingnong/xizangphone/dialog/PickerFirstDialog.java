 ...
 * 只有一列的datapickerdialog
 */

public class PickerFirstDialog extends Dialog {
    private Params params;

    public PickerFirstDialog(Context context, int themeResId) {
        super(context, themeResId);
    }

    private void setParams(PickerFirstDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final PickerFirstDialog.Params params;

        public Builder(Context context) {
            this.context = context;
            params = new PickerFirstDialog.Params();
        }
        ...
        public PickerFirstDialog create() {
            final PickerFirstDialog dialog = new PickerFirstDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
