...
public class BaseActivityPresenter<G extends IMVPActivity> implements Presenter<G> {
    //activity
//    private WeakReference<T> mActivity;
    ...
    private User user;
    public BaseActivityPresenter(G view) {
        attachActivity(view);
    }
...
//            user = new User();
    ...
    public String getFSUNITID() {
        //Log.e("-----------","------------------------------getUserId()-------------------------------");
        return String.valueOf(getUser().getFSUNITID());
    }
}
