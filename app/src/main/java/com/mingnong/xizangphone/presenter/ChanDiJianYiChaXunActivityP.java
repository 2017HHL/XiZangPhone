 ...
 */
public class ChanDiJianYiChaXunActivityP extends BaseActivityPresenter<IChanDiJianYiChaXunActivity>{
    public ChanDiJianYiChaXunActivityP(IChanDiJianYiChaXunActivity view) {
        super(view);
    }
