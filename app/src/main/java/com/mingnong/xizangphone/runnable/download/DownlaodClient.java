...
public class DownlaodClient {
    //    public static final String DOMAIN = "http://www.hndwwj.org.cn:8886/HuNanAPPNew/";
//    public static final String DOMAIN = "http://192.168.0.221:8886/XiZangAPP/";//本地
    public static final String DOMAIN = "http://220.182.3.2:8888/XZJYZMobileWebservice/";//本地
...
//        @GET("UserDatabase/HuNanApp.apk")
//        Call<ResponseBody> downloadApk();

        @GET("UserDatabase/XiZang.apk")
        Call<ResponseBody> downloadApk();
