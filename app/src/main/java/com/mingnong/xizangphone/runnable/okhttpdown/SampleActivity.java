package com.mingnong.xizangphone.runnable.okhttpdown;
...
import com.mingnong.xizangphone.runnable.okhttpdown.helper.ProgressHelper;
import com.mingnong.xizangphone.runnable.okhttpdown.listener.ProgressListener;
import com.mingnong.xizangphone.runnable.okhttpdown.listener.impl.UIProgressListener;
...
//                uploadProgress.setProgress((int) ((100 * bytesWrite) / contentLength));
        ...
        //进行包装，使其支持进度回调
        final Request request = new Request.Builder().url("http://121.41.119.107:81/test/result.php")
