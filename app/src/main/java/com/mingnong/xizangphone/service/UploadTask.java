...
import static com.mingnong.xizangphone.runnable.NetClient.URL_DOMAIN;
import static com.mingnong.xizangphone.service.UploadPictureListener.UPLOAD_ERROR_ERRORCODE_NOT_ZERO;
import static com.mingnong.xizangphone.service.UploadPictureListener.UPLOAD_ERROR_ERRORCODE_OTHER;
import static com.mingnong.xizangphone.service.UploadPictureListener.UPLOAD_ERROR_FILE_NOT_FOUND;
import static com.mingnong.xizangphone.service.UploadPictureListener.UPLOAD_ERROR_RESPONSE_NOT_SUCCESS;
...
//            throw new Exception("文件不存在");
        ...
        Request request = new Request.Builder()
                .url(URL_DOMAIN + "UploadWHHImages.ashx")
                .post(body)
                .build();
        try {
