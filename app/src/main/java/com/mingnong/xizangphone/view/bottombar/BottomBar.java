package com.mingnong.xizangphone.view.bottombar;
...
import com.mingnong.xizangphone.view.bottombar.scrollsweetness.BottomNavigationBehavior;
...
public class BottomBar extends RelativeLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void initializeViews() {
        ...
        View rootView = inflate(mContext, mIsTabletMode ?
                        R.layout.other_bb_bottom_bar_item_container_tablet : R.layout.other_bb_bottom_bar_item_container,
                this);
    ...
    private void updateItems(final BottomBarItemBase[] bottomBarItems) {
        ...
        for (BottomBarItemBase bottomBarItemBase : bottomBarItems) {
            ...
            if (mIsShiftingMode && !mIsTabletMode) {
                layoutResource = R.layout.other_bb_bottom_bar_item_shifting;
            } else {
                layoutResource = mIsTabletMode ?
                        R.layout.other_bb_bottom_bar_item_fixed_tablet : R.layout.other_bb_bottom_bar_item_fixed;
            }
    ...
    private void updateTitleBottomPadding() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (missingPadding > 0) {
                // Only updateApk the padding if really needed
