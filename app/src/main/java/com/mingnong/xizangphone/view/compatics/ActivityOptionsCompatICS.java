package com.mingnong.xizangphone.view.compatics;
...
import com.mingnong.xizangphone.view.compatics.transition.Position;
...
//	 * @param sharedElementId：新的activity中要接收动画效果的元素的id，这样就得到了两个view之间的联系
     ...
     * Context.loginSuccessful(Intent, Bundle)} and related methods.
     * Note that the returned Bundle is still owned by the ActivityOptions
     * object; you must not modify it, but can supply it to the loginSuccessful
