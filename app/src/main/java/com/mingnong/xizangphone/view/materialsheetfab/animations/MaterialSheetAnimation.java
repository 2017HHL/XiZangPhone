package com.mingnong.xizangphone.view.materialsheetfab.animations;
...
import com.mingnong.xizangphone.view.materialsheetfab.animation.SupportAnimator;
import com.mingnong.xizangphone.view.materialsheetfab.animation.ViewAnimationUtils;
...
public class MaterialSheetAnimation {
	...
	private static final int SHEET_REVEAL_OFFSET_Y = 2;
	//// TODO: 2016/11/30
...
//		}
	...
	protected void startCircularRevealAnim(View view, int centerX, int centerY, float startRadius,
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			...
			Animator anim = android.view.ViewAnimationUtils.createCircularReveal(view, centerX, centerY,
