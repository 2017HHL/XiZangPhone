...
package com.mingnong.xizangphone.view.recyclerview;
...
import com.mingnong.xizangphone.view.recyclerview.animation.AlphaInAnimation;
import com.mingnong.xizangphone.view.recyclerview.animation.BaseAnimation;
import com.mingnong.xizangphone.view.recyclerview.animation.ScaleInAnimation;
import com.mingnong.xizangphone.view.recyclerview.animation.SlideInBottomAnimation;
import com.mingnong.xizangphone.view.recyclerview.animation.SlideInLeftAnimation;
import com.mingnong.xizangphone.view.recyclerview.animation.SlideInRightAnimation;
import com.mingnong.xizangphone.view.recyclerview.listener.OnItemDragListener;
import com.mingnong.xizangphone.view.recyclerview.listener.OnItemSwipeListener;
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.other_def_loading);
        }
    ...
    /**
     * @param layoutResId ID for an XML layout resource to loadmore
     ...
     *
     * @param firstOnly true just show anim when first loading false show anim when loadmore the data every time
     */
