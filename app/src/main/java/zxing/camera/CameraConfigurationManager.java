...
final class CameraConfigurationManager {
	...
	/**
	 * Reads, one time, values from the other_camera that are needed by the app.
	 */
	...
	/**
	 * Sets the other_camera up to take preview images which are used for both preview
	...
	private static Point getCameraResolution(Camera.Parameters parameters,
		...
		if (cameraResolution == null) {
			// Ensure that the other_camera resolution is a multiple of 8, as the
			// screen may not be.
