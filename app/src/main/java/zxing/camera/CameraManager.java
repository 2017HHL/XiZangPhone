...
public final class CameraManager {
	 ...
	 *
	 * @param context
	 *            The Activity which wants to use the other_camera.
	 */
	...
	/**
	 * Opens the other_camera driver and initializes the hardware parameters.
	 *
	 * @param holder
	 *            The surface object which the other_camera will draw preview frames
	 *            into.
	 * @throws IOException
	 *             Indicates the other_camera driver failed to open.
	 */
	...
	/**
	 * Closes the other_camera driver if still in use.
	 */
	...
	/**
	 * Asks the other_camera hardware to begin drawing preview frames to the screen.
	 */
	...
	/**
	 * Tells the other_camera to stop drawing preview frames.
	 */
	...
	/**
	 * Asks the other_camera hardware to perform an autofocus.
	 *
	 * @param handler
